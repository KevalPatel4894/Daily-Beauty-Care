...
object BodyPolish {
    ...
    fun remedy(context: Context): ArrayList<ListModel> {
        ...
        listModel.title = context.getString(R.string.for_improving_blood_circulation)
        listModel.descriptionName = context.getString(R.string.fifteen_min)
        listModel.image = R.drawable.polish_bloodcirculation
        listModel.details = context.getString(R.string.bodypolish_for_improving_blood_circulation)
        list.add(listModel)
        val listModel1 = ListModel()
        listModel1.title = context.getString(R.string.for_detoxing)
        listModel1.descriptionName = context.getString(R.string.ten_min)
        listModel1.image = R.drawable.polish_detoxing
        listModel1.details = context.getString(R.string.bodypolish_for_detoxing)
        list.add(listModel1)
        val listModel2 = ListModel()
        listModel2.title = context.getString(R.string.for_nourishing)
        listModel2.descriptionName = context.getString(R.string.ten_min)
        listModel2.image = R.drawable.polish_nourishing
        listModel2.details = context.getString(R.string.bodypolish_for_nourishing)
        list.add(listModel2)
        val listModel3 = ListModel()
        listModel3.title = context.getString(R.string.for_blackheads_whiteheads)
        listModel3.descriptionName = context.getString(R.string.ten_min)
        listModel3.image = R.drawable.polish_blackheads
        listModel3.details = context.getString(R.string.bodypolish_for_blackheads_whiteheads)
        list.add(listModel3)
        val listModel4 = ListModel()
        listModel4.title = context.getString(R.string.all_time_fav)
        listModel4.descriptionName = context.getString(R.string.ten_min)
        listModel4.image = R.drawable.body_polishing_title
        listModel4.details = context.getString(R.string.bodypolish_all_time_fav)
        list.add(listModel4)
        return list
    }
    ...
    fun exercise(context: Context): ArrayList<ListModel> {
        val list = ArrayList<ListModel>()
        val listModel = ListModel()
        listModel.title = context.getString(R.string.skin_type)
        listModel.descriptionName = context.getString(R.string.skin_type_detail)
        listModel.image = R.drawable.skintype
        listModel.details = context.getString(R.string.bodypolish_skin_type)
        list.add(listModel)
        val listModel1 = ListModel()
        listModel1.title = context.getString(R.string.not_involve_face)
        listModel1.descriptionName = context.getString(R.string.not_involve_face_detail)
        listModel1.image = R.drawable.notface
        listModel1.details = context.getString(R.string.bodypolish_not_involve_face)
        list.add(listModel1)
        val listModel2 = ListModel()
        listModel2.title = context.getString(R.string.week_gap)
        listModel2.descriptionName = context.getString(R.string.week_gap_detail)
        listModel2.image = R.drawable.week_gap
        listModel2.details = context.getString(R.string.bodypolish_week_gap)
        list.add(listModel2)
        val listModel3 = ListModel()
        listModel3.title = context.getString(R.string.dont_overdo)
        listModel3.descriptionName = context.getString(R.string.dont_overdo_detail)
        listModel3.image = R.drawable.dont_overdo
        listModel3.details = context.getString(R.string.bodypolish_dont_overdo)
        list.add(listModel3)
        val listModel4 = ListModel()
        listModel4.title = context.getString(R.string.avoid_sun)
        listModel4.descriptionName = context.getString(R.string.avoid_sun_small)
        listModel4.image = R.drawable.thighs_avoidsun
        listModel4.details = context.getString(R.string.bodypolish_dont_avoidsun)
        list.add(listModel4)
        val listModel5 = ListModel()
        listModel5.title = context.getString(R.string.medical_clearance)
        listModel5.descriptionName = context.getString(R.string.medical_clearance_detail)
        listModel5.image = R.drawable.medications
        listModel5.details = context.getString(R.string.bodypolish_medical_clearance)
        list.add(listModel5)
        val listModel6 = ListModel()
        ...
        listModel6.image = R.drawable.body_polishing_title
        listModel6.details = context.getString(R.string.bodypolish_additional)
        list.add(listModel6)
        return list
    }
}